        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="<?=base_url('admin/berita/edit/').$detail['id_berita']?>" class="btn btn-sm btn-success mt-2"><i class="fas fa-edit"></i> Edit</a>

              <?php if ($detail['status_berita'] == 'aktif'): ?>
                <a href="<?=base_url('admin/berita/non_aktif/').$detail['id_berita']?>" class="btn btn-sm btn-danger mt-2"><i class="fas fa-times"></i> Non Aktifkan</a>
              <?php endif ?>
              <?php if ($detail['status_berita'] == 'non aktif'): ?>
                <a href="<?=base_url('admin/berita/aktif/').$detail['id_berita']?>" class="btn btn-sm btn-success mt-2"><i class="fas fa-check"></i> Aktifkan</a>

                <a href="<?=base_url('admin/berita/delete/').$detail['id_berita']?>" class="btn btn-sm btn-danger mt-2"><i class="fas fa-trash"></i> Delete</a>
              <?php endif ?>
            </div>
          </div>
        </div>
