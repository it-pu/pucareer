        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <?php echo form_open_multipart(base_url('admin/agenda/update')); ?>
              ...
              <div class="form-group">
                ...
                <input type="date" name="tgl_agenda" value="<?=$detail['tgl_agenda']?>" class="form-control" aria-describedby="" required>
              </div>
              <div class="form-group">
