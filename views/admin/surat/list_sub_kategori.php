        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <a href="<?=base_url('admin/surat/add_sub_kategori')?>" class="btn btn-primary mb-3 col-md-3" style="width: auto;"><i class="fas fa-plus"></i> Tambah Sub Kategori</a>
              ...
              <div class="table-responsive">
                <table class="table align-items-center" id="table_data">
                  ...
                  <tbody>
                    <?php foreach ($skategori as $key => $value): ?>
                      <tr>
                        <td><?=$key+1?></td>
                        <td><?=$value['nama_surat_kategori_sub']?></td>
                        <td><?=$value['nama_kategori_surat']?></td>
                        <td>
                            <a href="<?=base_url('admin/surat/edit_sub_kategori/').$value['id_surat_kategori_sub']?>" class="btn btn-success btn-sm"><i class="fas fa-edit"></i> Edit</a>
                        </td>
                      </tr>
                    <?php endforeach ?>
                  </tbody>
